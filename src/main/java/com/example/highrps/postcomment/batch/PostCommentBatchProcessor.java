...
public class PostCommentBatchProcessor implements EntityBatchProcessor {
    ...
    public void processUpserts(List<String> payloads) {
        ...
        List<ParsedComment> parsedComments = payloads.stream()
                .map(payload -> {
                    ...
                    try {
                        PostCommentCommandResult result = jsonMapper.readValue(payload, PostCommentCommandResult.class);
    ...
    private void updateCommentEntity(PostCommentCommandResult result, PostCommentEntity entity) {
    ...
    private record ParsedComment(Long commentId, Long postId, PostCommentCommandResult result) {}
}
